      ...
      sectionContent={
        <div>
          <p>
            ...
            Ergebnisse von Simulationsberechnungen, die im Auftrag der Stadt Wuppertal 
            und der Wuppertaler Stadtwerke (WSW Energie und Wasser AG) durch das 
            Ingenieurbüro Dr. Pecher AG (Erkrath) durchgeführt wurden.
          </p>
          <p>
            Bei den katastrophalen Überschwemmungen am 14. und 15. Juli 2021, die   
            vor allem im Ahrtal verheerende Schäden angerichtet und viele   
            Menschenleben gekostet haben, war auch die Stadt Wuppertal betroffen. Es 
            handelte sich um ein kombiniertes Starkregen- und Flusshochwasserereignis, 
            das von Simulationen, wie sie für die Starkregengefahrenkarte gemacht 
            werden, nicht abgebildet wird. Simulationen für Flusshochwasser werden 
            in einem Turnus von sechs Jahren vom Land NRW für die sog. Risikogewässer 
            durchgeführt. In Wuppertal sind das neben der Wupper die Schwelme, der 
            Mirker Bach, der Morsbach, der Hardenberger Bach und der Deilbach. Auch 
            wenn es keine gängigen Simulationsansätze für kombinierte Starkregen- 
            und Flusshochwasserereignisse gibt, kann doch mit einer parallelen 
            Darstellung der Gefährdung durch Starkregenabfluss und Flusshochwasser 
            ...
            die neue Hochwassergefahrenkarte mit der Starkregengefahrenkarte so 
            gekoppelt werden können, dass die Nutzer/innen bei der gleichzeitigen 
            Betrachtung der Gefährdungen durch Starkregen und Hochwasser bestmöglich 
            unterstützt werden.  
          </p>
          <p>
